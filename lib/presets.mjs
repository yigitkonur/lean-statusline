...
export const PRESETS = {
    minimal: {
        ...
        sample: `🔒 mac-mini · Opus 4.7 · context 3% · ~/repo`,
        config: {
            segments: ['ssh', 'model', 'ctx', 'dir', 'rate-5h-full', 'rate-7d-full'],
    ...
    compact: {
        ...
        sample: [
            `🔒 mac-mini · Opus 4.7 · context 3% · ~/repo`,
    ...
    full: {
        ...
        sample: [
            `🔒 mac-mini · Opus 4.7 · context 3% · ~/repo · ◐ auto · ⏱ 45m · 🤖×2`,
        ...
        config: {
            ...
            //   - ssh/model/dir/rate-5h-full/rate-7d-full/context-bar on by default.
