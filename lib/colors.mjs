...
const PALETTES = Object.freeze({
    ...
    // Catppuccin Latte — pastel scheme. Accent hues are Latte's official
    // spec; `white` is remapped to `subtext1` (#acb0be) so labels read on
    // dark terminals (the common CC deployment). Trade-off: slightly lower
    // contrast on true-light terminal backgrounds, acceptable for 1.5.x.
    'catppuccin-latte': {
        ...
        white:   [172, 176, 190],   // #acb0be (subtext1 — readable on dark bg)
